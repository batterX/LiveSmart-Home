...
$('#pin').on('change', function() {
	...
	var entity = $('#pin').find('option:selected').val().charAt(7);
...
$('#submit').on('click', function() {
	...
	// ENTITY
	entity = $('#pin').find('option:selected').val().charAt(7);
	
	// MODE
	mode = $('#active').find('option:selected').val().toLowerCase();
	if(mode == 'enable') mode = 1; else mode = 0;
