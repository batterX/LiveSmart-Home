...
<html>
	...
	<body>
					...
					<div class="modal-body">
						...
						<?php if($isTor): ?>
							...
							<div class="form-group row mb-3">
								<label class="col-6 col-form-label col-form-label-sm"><?php echo $lang["system_setup"]["extended_uefftime"] ?></label>
								<div class="col-6 d-flex align-items-center">
									<div class="input-group input-group-sm">
										<input id="extended_UeffTime" class="form-control form-control-outline text-monospace" type="number" step="1" min="3" max="100" value="10" placeholder="10" title="Range: 3 - 100">
							...
							<div class="form-group row mb-2">
								...
								<div class="col-6 d-flex align-items-center">
									<div class="input-group input-group-sm">
										<input id="extended_gridConnectDelay" class="form-control form-control-outline text-monospace" type="number" step="1" min="1" max="300" value="300" placeholder="300" title="Range: 1 - 300">
							...
							<div class="form-group row mb-3">
								...
								<div class="col-6 d-flex align-items-center">
									<div class="input-group input-group-sm">
										<input id="extended_puTime" class="form-control form-control-outline text-monospace" type="number" step="1" min="3" max="60" value="5" placeholder="5" title="Range: 3 - 60">
										<div class="input-group-append"><span class="input-group-text">sec</span></div>
									</div>
								</div>
							</div>
						...
						<div class="form-group row mb-2">
							...
							<div class="col-6 d-flex align-items-center">
								<select id="extended_dropRatedPowerPoint" class="form-control form-control-sm form-control-outline text-monospace">
						...
						<div class="form-group row mb-0">
							...
							<div class="col-6 d-flex align-items-center">
								<div class="input-group input-group-sm">
									<input id="extended_dropRatedPowerSlope" class="form-control form-control-outline text-monospace" type="number" step="1" min="10" max="100" value="40" placeholder="40">
		...
		<div class="modal fade" id="modalConfirmExtendedParameters" tabindex="-1" role="dialog">
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<h5 class="modal-header mb-0">Confirm Extended Parameters</h5>
					<div class="modal-body">
					...
					<div class="modal-footer justify-content-between">
						...
						<button type="button" class="confirm btn btn-sm px-4 py-2 btn-success ripple" style="min-width:40%"><b>Confirm</b></button>
					</div>
				</div>
			</div>
		</div>
