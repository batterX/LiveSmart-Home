			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					...
					<div class="modal-body">
						<h6 class="py-2 mb-2" style="font-size:0.875rem"><b><?php echo $lang["system_setup"]["extended_overfrequency_reduction"] ?></b></h6>
						<div class="form-group row mb-2">
							...
							<div class="col-6 d-flex align-items-center">
								<select id="extended_dropRatedPowerPoint" class="form-control form-control-sm form-control-outline">
						...
						<div class="form-group row mb-0">
							...
							<div class="col-6 d-flex align-items-center">
								<div class="input-group input-group-sm">
									<input id="extended_dropRatedPowerSlope" class="form-control form-control-outline" type="number" step="1" min="10" max="100" value="40" placeholder="40">
...
MPPT 2
	...
	String 2: ..."></textarea>
					...
					<div class="col-12 pt-5 <?php echo $isTor ? "tor" : "vde4105" ?> <?php echo ($isVde4105 || $isTor) ? "" : "d-none" ?>">
										...
										<div class="form-group row mx-n2 mb-0">
											...
											<div class="col-lg-9 col-7 px-2">
												<select class="form-control form-control-outline" id="reactive_mode">
													<option value=""  <?php echo ($isVde4105 || $isTor) == "1" ? "selected" : "" ?>></option>
													<option value="0" <?php echo ($isVde4105 || $isTor) == "1" ? "" : "selected" ?>><?php echo $lang["dict_reactive_mode"]["0"] ?></option>
