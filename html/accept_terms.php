	...
	<body>
		...
		<div class="container pb-5">
			...
			<?php if($installerCountry == "de"): ?>
				...
				<p class="text-center mb-5">gültig zwischen VISION UPS Systems Sàrl und in Deutschland ansässigen Vertriebspartnern<br>Version 010720 vom 01.07.2020 und für folgende Speichersysteme sowie authorisierte Speichererweiterungen:<br><b>batterX HOME: h10R-7, h10R-10,5, h10R-14, h10W-7, h10W-10,5, h10W-14</b><br><b>batterX COM: h10R-28, h10R-42, h10R-56</b></p>
				...
				<p>Der Garantiefall tritt ein, wenn die Kapazität der Batteriezellen 80% (achtzig Prozent) der Nennkapazität unterschreitet.</p>
				...
				<p>Das System besitzt eine gültige Seriennummer,</p>
				<p>Es ist in Deutschland installiert worden,</p>
				<p>Es wurde nach der Bedienungsanleitung und den gültigen Vorschriften installiert, betrieben und gewartet.</p>
				<p>Es wurde eine regelmäßige Reiningung der Ventilatoren durchgeführt, falls der Wechselrichter in staubiger Umgebung installiert wurde.</p>
				<p>Es nimmt nicht mehr als 365 Volladezyklen pro Jahr vor.</p>
				<p>Eine allfällige Speichererweiterung wurde in den vom Hersteller vorgesehenen Kapazitätsstufen von einem geschulten Techniker nicht länger als 18 Monate nach dem Datum der Erstinstallation durchgeführt, wobei nur Originalkomponenten verwendet wurden und gemäß dem Produkthandbuch vorgegangen wurde.</p>
				...
				<p>h)	wenn das Gerät mechanische Beschädigungen irgendwelcher Art aufweist, gleichgültig ob diese bei Transport oder danach enstanden sind,</p>
				<p>i)	wenn der Wechselrichter mehr als 3 Mal im USV-Betrieb einer Überlast von mehr als 3300W pro Phase ausgesetzt war (zB. wenn das Gerät im Verlauf eines Stromausfalles und gleichzeitiger Überlast mehr als 2 Mal vom Kunden manuell wieder eingeschaltet wird). </p>
				<p>j)	wenn der Wechselrichter mit nicht von Vision UPS Systems Sarl für dieses System verkauften Batterien oder anderen Systemteilen bzw. nicht vom Hersteller authorisierten Komponenten betrieben wurde. </p>
				<p>k)	wenn der Garantieanspruch nicht den Garantiebedingungen entsprechend angemeldet worden ist, oder Transportschäden nicht gemäß den Garantiebedingungen angezeigt wurden.</p>
				<p>l)	Bei Fehlen der Voraussetzungen aus Punkt 3.</p>
				...
				<p>g)	wenn der Wechselrichter mehr als 3 Mal im USV-Betrieb einer Überlast von mehr als 3300W pro Phase ausgesetzt war (zB. wenn das Gerät im Verlauf eines Stromausfalles und gleichzeitiger Überlast mehr als 2 Mal vom Kunden manuell wieder eingeschaltet wird). </p>
			...
			<?php elseif(in_array($installerCountry, ["at", "ch"])): ?>
				...
				<p class="text-center mb-5">gültig zwischen VISION UPS Systems Sàrl und Vertriebspartnern<br>in deutschsprachigen Ländern und Gebieten außerhalb der Bundesrepublik Deutschland<br>Version 230320 vom 23. März 2020<br><br>Die Garantie gilt für folgende Speichersysteme:<br><b>h10R-7, h10R-10,5, h10R-14,	h10W-7, h10W-10,5, h10W-14, h10R-28, h10R-42, h10R-56</b></p>
				...
				<p>g.	wenn das Gerät mechanische Beschädigungen irgendwelcher Art aufweist, gleichgültig ob diese bei Transport oder danach enstanden sind,</p>
				<p>h.	wenn der Wechselrichter mehr als 3 Mal im USV-Betrieb einer Überlast von mehr als 3300W pro Phase ausgesetzt war (zB. wenn das Gerät im Verlauf eines Stromausfalles und gleichzeitiger Überlast mehr als 2 Mal vom Kunden manuell wieder eingeschaltet wird). </p>
				...
				<p>e.	Verwendung bei Umgebungs¬temperaturen außerhalb einer Temperatur von 5°C und 40°C sowie einer Temperatur von weniger als 15°C oder mehr als 30°C  im Mittel,</p>
				<p>f.	Verwendung der Batterie unterhalb der maximalen Entladetiefe.</p>
				<p>l.	wenn der Wechselrichter mehr als 3 Mal im USV-Betrieb einer Überlast von mehr als 3300W pro Phase ausgesetzt war (zB. wenn das Gerät im Verlauf eines Stromausfalles und gleichzeitiger Überlast mehr als 2 Mal vom Kunden manuell wieder eingeschaltet wird). </p>
				<p>g.	jegliche physische Beschädigung</p>
				<p>h.	Öffnung, Reparatur, Modifikationen oder Programmierung durch nicht von VISION UPS oder dessen Vertriebspartner beauftragte bzw. autorisierte Personen,</p>
				<p>i.	Wasser, Kälte, Feuer, Staub, korrodierendes Gas, für welche die Schutzklasse IP20 des Geräts nicht geeignet ist</p>
				<p>j.	Verwendung mit anderen Typen von Batterien</p>
				<p>k.	anderweitige Verwendung, als in der Bedienungsanleitung angegeben</p>
				<p>l.	Beschädigung der Batterien durch Feuer, Frost, Vernachlässigung, höhere Gewalt, Missbrauch oder Zerstörung.</p>
				<p>m.	Wenn der Garantieanspruch nicht den Garantiebedingungen entsprechend angemeldet worden ist, oder Transportschäden nicht gemäß den Garantiebedingungen angezeigt wurden.</p>
				<p>n.	Bei Fehlen der Voraussetzungen aus Punkt 3.</p>
			...
			<?php else: ?>
				...
				<p class="text-center mb-5">Valid between VISION UPS Systems Sàrl and Distributors.<br>Version 080220 of February 08, 2020<br><br>The warranty applies to the following storage systems:<br><b>h10R-7, h10R-10,5, h10R-14, h10W-7, h10W-10,5, h10W-14, h10R-28, h10R-42, h10R-56</b></p>
				...
				<p>The warranty period of 10 years is valid a) after initial installation of the product or  for a maximum of 10 years and 6 months afte the date of manufacturing.</p>
				...
				<p>h.	the inverter has been subjected to an overload of more than 3300W per phase more than 3 times during UPS operation (e.g. if the device is manually switched on again by the customer more than 2 times during a power failure and simultaneous overload).</p>
				<p>i.	the inverter has been operated with batteries or other system components not sold by Vision UPS Systems Sarl for this system, or with components not authorized by the manufacturer. </p>
				...
				<p>k.	In the absence of the conditions set out in point 3.</p>
				...
				<p>g.	   the inverter has been exposed to an overload of more    than 3300W per phase more than 3 times in UPS operation (e.g. if the device is manually switched on again more than 2 times by the customer during a power failure and simultaneous overload). </p>
